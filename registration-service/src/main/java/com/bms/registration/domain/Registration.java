package com.bms.registration.domain;
...
public class Registration {
	...
	public Registration(int registrationId, String name, String username, String password, String address,
			String country, String state, String emailAddress, int contactNo,
			String dateOfBirth, 
			String accountType,
			int accountNo, String branchName, int initialDepositAmount, String identificationProofType,
